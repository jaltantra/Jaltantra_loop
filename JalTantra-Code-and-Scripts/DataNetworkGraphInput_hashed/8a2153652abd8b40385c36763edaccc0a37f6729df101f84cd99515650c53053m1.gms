...
alias (src,srcs);
alias (nodes,j) ;
Set arcs(nodes,j) /4.6, 3.7, 2.6, 2.4, 9.3, 8.9, 10.2, 3.10, 11.1, 4.11/

Parameters
	Len(nodes,j) /4    .6    318.0, 3    .7    7345.0, 2    .6    3491.0, 2    .4    2442.0, 9    .3    1943.0, 8    .9    2686.0, 10    .2    4808.0, 3    .10    924.0, 11    .1    4266.0, 4    .11    485.0/
