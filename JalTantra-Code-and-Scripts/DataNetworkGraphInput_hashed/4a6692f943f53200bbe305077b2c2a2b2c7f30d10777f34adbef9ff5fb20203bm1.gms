...
alias (src,srcs);
alias (nodes,j) ;
Set arcs(nodes,j) /2.4,  2.3,  3.5,  4.5,  4.6,  7.5,  6.7/;
Set F_arcs(nodes,j) /1.2/;

Parameters
	Len(nodes,j) /2	.4	1000.0,  2	.3	1000.0,  3	.5	1000.0,  4	.5	1000.0,  4	.6	1000.0,  7	.5	1000.0,  6	.7	1000.0/
	F_L(nodes,j) /1	.2	1000.0/
	...
	F_d(F_arcs) /1	.2	457.2/
	F_R(F_arcs) /1	.2	130.0/;
