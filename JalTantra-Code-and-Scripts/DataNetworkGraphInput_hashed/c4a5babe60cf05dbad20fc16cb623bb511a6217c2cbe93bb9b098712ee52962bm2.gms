...
alias (src,srcs);
alias (nodes,j) ;
Set arcs(nodes,j) /2.4, 2.3, 3.5, 4.5, 4.6, 6.7/

Parameters
	Len(nodes,j) /2    .4    1000.0, 2    .3    1000.0, 3    .5    1000.0, 4    .5    1000.0, 4    .6    1000.0, 6    .7    1000.0/
	...
	dis(pipes) / 0 25.4,  1 50.8,  2 76.2,  3 101.6,  4 152.4,  5 203.2,  6 254.0,  7 304.8,  8 355.6,  9 406.4,  10 457.2,  11 508.0,  12 558.8, 13 609.6/
